namespace Calculator.Implementations.RegexCalculator.Operations
{
    ...
    public class MultiplicationMathOperation : IMathOperation
    {
        private readonly IEvaluationContext _context;

        /// <summary>
        /// Initializes a new instance of the <see cref="MultiplicationMathOperation"/> class.
        /// </summary>
        /// <param name="context">
        /// The context.
        /// </param>
        public MultiplicationMathOperation(IEvaluationContext context)
        {
            _context = context;
        }
